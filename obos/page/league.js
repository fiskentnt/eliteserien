...
const LEAGUE = {
  ...
  bands: [
    ...
    {cls: 'eu', lo: 3, hi: 6, legend: 'Opprykkskvalifisering (3 til 6)'},
  ...
  zones: {
    gull: {lo: 1, hi: 2, label: 'direkte opprykk', decided: 'direkte opprykk', kampOm: 'de to opprykksplassene', chance: 'opprykkssjansen',
    ...
    cl: null,
    europa: {lo: 1, hi: 6, label: 'topp 6', kampOm: 'topp 6-plassene', chance: 'topp 6-sjansen', reach: 'nå topp 6',
    ...
    kvalik: {lo: 14, hi: 14, boundary: 13, label: 'kvalik', kampOm: 'å unngå kvalik', chance: 'kvaliksjansen',
             reach: 'unngå både nedrykk og kvalik', safe: 'sikret mot både nedrykk og kvalik',
             verb: 'unngår både nedrykk og kvalik', strid: 'kvalikstriden',
             da: 'unngår {team} både nedrykk og kvalik', boxLabel: 'Kvalik', boxAlways: true},
    nedrykk: {lo: 15, hi: 16, boundary: 13, label: 'nedrykk', kampOm: 'å unngå nedrykk', chance: 'nedrykkssjansen',
              reach: 'unngå både nedrykk og kvalik', safe: 'sikret mot både nedrykk og kvalik',
              verb: 'unngår både nedrykk og kvalik', strid: 'nedrykksstriden',
              da: 'unngår {team} både nedrykk og kvalik', boxLabel: 'Nedrykk', boxAlways: true},
  },
  badges: [
    ...
    {above: 6, cls: 'europe', text: 'Sikret topp 6', note: 'Sikret topp 6: kan ikke havne lavere enn 6. plass, så laget får minst opprykkskvalifisering.'},
    // Vises ikke for lag som fortsatt kan nå topp 6: for dem er opprykkskvalifisering
